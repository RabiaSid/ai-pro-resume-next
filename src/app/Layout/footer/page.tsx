    ...
    <footer className="bg-primaryBlue text-white ">
      <div className="p-6">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 xl:col-span-4 flex flex-col items-start justify-between border-gray-400 border-r-[0px] xl:border-r-[2px] pr-0 lg:pr-5">
            <div>
              ...
              <div className="mt-4">
                ...
                <p className="text-white text-sm md:text-lg font-Lexend my-3 xl:my-1">
            ...
            <form
              ...
              className="w-full mt-5 md:mt-0 mb-3 xl:mt-0"
            >
              <div className="flex items-center bg-primaryBlue border-2 border-white rounded-3xl text-white w-full max-w-full">
                <input
                  ...
                  className="flex-1 bg-transparent text-white outline-none text-xs lg:text-base px-2 lg:px-3 placeholder:text-white focus:text-white transition-all duration-300 ease-in"
                />
                <button
                  type="submit"
                  className={`bg-primaryCran opacity-100 text-white font-semibold min-w-[40px] text-[12px] lg:text-sm px-2 lg:px-5 py-2 rounded-r-3xl transition-all duration-300 ease-in hover:opacity-80 ${
          ...
          <div className="col-span-12 xl:col-span-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-4 mb-10 lg:mb-0">
                ...
                <ul className="text-white flex flex-col gap-4">
                  {section.links.map((link, idx) => (
                    <li key={idx}>
                      <Link
                        href={link.href}
                        className="hover:text-primaryCran font-Lexend font-light text-base"
                      >
                        {link.label}
                      </Link>
                    </li>
        ...
        <div className="lg:hidden flex flex-wrap items-center gap-4 text-4xl my-2">
          {socialLinks.map(({ href, icon: Icon }, index) => (
            <a
              ...
              href={href}
              className="hover:text-primaryCran"
            >
            ...
            <div className="flex flex-wrap items-center justify-start gap-6 text-[40px] w-full">
              {socialLinks.map(({ href, icon: Icon }, index) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  href={href}
                  className="hover:text-primaryCran w-[40px] h-[40px] rounded-full border-white border-2 flex justify-center items-center p-[4px]"
                >
        ...
        <div className="flex items-center justify-center lg:justify-between my-2">
          <Link
            href="https://www.softtechcube.com/"
            className="text-center md:text-left"
          >
            <span className="text-center text-md xl:text-left">
              © {getCurrentYear()}
