...
const Search = () => {
  ...
  return (
    <>
      <div className="bg-white border border-1 border-[#00caa5] w-[90%] sm:w-[70%] lg:w-[665px] m-auto flex lg:justify-between items-center shadow-[0px_0px_20px_0px_rgba(0,0,0,0.1)] rounded-full text-[#13b6b5] p-2 my-24">
        <BiSearch
          size={32}
