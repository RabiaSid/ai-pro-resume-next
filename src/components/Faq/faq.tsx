...
const dummyFaqs: Faq[] = [
    { question: "What is Next.js?", answer: "Next.js is a React framework for production.", page: "Home" },
    { question: "How to install Next.js?", answer: "You can install it using 'npx create-next-app@latest'.", page: "Home" },
    { question: "What is a Resume Template?", answer: "A resume template is a pre-designed layout for resumes.", page: "Resume Template" },
    { question: "How to use a Resume Template?", answer: "You can customize a resume template according to your details.", page: "Resume Template" }
];
                            ...
                            .map((faq, i) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <svg
                                            className={`transition duration-500  ${expanded === i ? "rotate-180 text-[#0072b180]" : "text-[#0072b1]"
                                                }`}
                                            width="22"
                                            height="22"
                                            viewBox="0 0 22 22"
