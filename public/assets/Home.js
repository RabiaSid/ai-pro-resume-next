...
import service_1 from "./img/service_1.png";
import service_2 from "./img/service_2.png";
import service_3 from "./img/service_3.png";
import banner_about from "./img/main_image.png";
...
import circle_icon_1 from "./img/circle_icon_1.png";
import circle_icon_2 from "./img/circle_icon_2.png";
import circle_icon_3 from "./img/circle_icon_3.png";
import circle_icon_4 from "./img/circle_icon_4.png";
...
// Slider Image
import MainSliderImage1 from "./img/home_slider/slider_1.png";
import MainSliderImage2 from "./img/home_slider/slider_2.png";
...
//
import shadeImage01 from "./img/pattrens/01.png";
import shadeImage02 from "./img/pattrens/02.png";
import shadeImage03 from "./img/pattrens/03.png";
import PattrenGreen from "./img/pattrens/multi-liners-blue.png";
//
import ResumeHomeShow from "./components/ResumeHomeShow";
import TawkToWidget from "./TawkToWidget";
import Faq from "./Faq.js";
import AIChatBot from "./components/ai-chatbot/AIChatBot.js";
import { FaCrosshairs } from "react-icons/fa";
import AiChatBotIcon from "./img/robot.png";
              ...
              <div className="text-left py-6 mt-4">
                ...
                <div className="flex flex-row items-center gap-2 sm:gap-6 py-5 sm:hidden">
                  <NinaButton
                    ...
                    link={user?.token ? "/import_resume" : "/login"}
                  />
                  ...
                  <NinaButton
                    ...
                    mainTextColor={"#FFFFFF"}
                    hoverTextColor={"#0072b1"}
                    link={user?.token ? "/resume_templates" : "/login"}
                  />
                </div>
...
text-[#0072b1] font-lexend font-bold text-xl md:text-3xl  w-[100%] drop-shadow-lg sm:py-6"
          ...
          <div className="flex justify-center items-center w-full pt-8 my-4 text-center">
            <NinaButton
              ...
              mainTextColor={"#FFFFFF"}
              hoverTextColor={"#0072b1"}
              link={user?.token ? "/resume_templates" : "/resume_templates"}
            />
          </div>
        </section>
